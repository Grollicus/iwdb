...
namespace IWDB {
	...
	abstract class IWDBRegex {
		...
		public const String Pr‰ziseIWZeit = @"\d{2}\.\d{2}\.\d{4}\s\d{2}:\d{2}:\d{2}";
        ...
        public const String RessourcenName = @"(?:Eisen|Stahl|VV4A|chem\.\sElemente|Eis|Wasser|Energie|Pinguine|Credits|Bevˆlkerung)";
	}
    class Pair<T1, T2> {
        public T1 Item1;
        public T2 Item2;
