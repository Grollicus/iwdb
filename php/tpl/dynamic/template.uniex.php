<?php
	...
	function TemplateUniViewEx() {
		...
		echo '<table class="tablesorter" cellpadding="0" cellspacing="0" border="0"><thead>
	...
	function TemplateViewFilteredUniverseEx() {
		...
		echo '</thead><tbody><tr><td><b>Spalten</b><br /><i>Mehrfachauswahl mit [Strg]</i></td><td><select name="spalten[]" multiple="multiple" size="4">';
